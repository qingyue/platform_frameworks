...
enum {
	...
	METADATA_KEY_IS_DRM_CRIPPLED = 16,
	METADATA_KEY_CODEC           = 17,
	METADATA_KEY_RATING          = 18,
	METADATA_KEY_COMMENT         = 19,
	METADATA_KEY_COPYRIGHT       = 20,
	METADATA_KEY_BIT_RATE        = 21,
	METADATA_KEY_FRAME_RATE      = 22,
	METADATA_KEY_VIDEO_FORMAT    = 23,
	METADATA_KEY_VIDEO_HEIGHT    = 24,
	METADATA_KEY_VIDEO_WIDTH     = 25,
    // Add more here...
};
